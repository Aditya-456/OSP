    ...
    if request.method == 'POST':
        ...
        if password1 == password:
            ...
            try:
                ...
                messages.success(
                    request, 'Username already exists try another one')
                return redirect('register')
                ...
                messages.success(
                    request, 'Customer Account created for '+username)
    ...
    if request.method == 'POST':
        ...
        if password1 == password:
            ...
            try:
                ...
                messages.success(
                    request, 'Manager Account created for '+username)
    ...
    if request.method == 'POST':
        ...
        if password1 == password:
            ...
            try:
                ...
                messages.success(
                    request, 'Seller Account created for '+username)
...
def managerdashboard(request):
    ...
    context = {'customers': customers, 'sellers': sellers, 'total_customers': total_customers,
               'total_sellers': total_sellers, 'orders': orders, 'products': products}
